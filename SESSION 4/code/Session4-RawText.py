...
def gen_data_and_vocab():
    ...
    vocab.sort()
    with open('D:\\ban\\Phase-1\\Lab_training\\SESSION 4\\data\\vocab-raw.txt', 'w') as f:
        f.write('\n'.join(vocab))
    ...
    with open('D:\\ban\\Phase-1\\Lab_training\\SESSION 4\\data\\20news-train-raw.txt', 'w') as f:
        f.write('\n'.join(train_data))

    with open('D:\\ban\\Phase-1\\Lab_training\\SESSION 4\\data\\20news-test-raw.txt', 'w') as f:
        f.write('\n'.join(test_data))
